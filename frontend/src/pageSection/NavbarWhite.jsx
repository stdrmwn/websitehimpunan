              ...
              <ul className="absolute right-0 mt-3 w-[240px] bg-white rounded-lg shadow-md py-3 px-4 z-50">
                ...
                <li className="mt-3">
                  <a
                    ...
                    className="block w-full text-center border border-[#2889CE] text-[#2889CE] hover:text-white hover:bg-[#2889CE] font-medium p-2 rounded-2xl transition-colors duration-200"
                  >
                    Login
                  </a>
                </li>
