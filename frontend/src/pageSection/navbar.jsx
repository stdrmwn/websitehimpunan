              ...
              {dropdownOpen && (
                <ul className="absolute right-0 mt-3 w-[240px] bg-white rounded-lg shadow-md py-3 px-4 z-50">
                  <li onClick={() => setDropdownOpen(false)}>
                    <Link to="/" className="block px-4 py-2 text-[#2889CE] hover:bg-blue-50 rounded-lg transition-all">
                      Beranda
                    </Link>
                  </li>
                  <li>
                        ...
                        <li onClick={() => setDropdownOpen(false)}>
                          <Link to="/faq" className="block px-4 py-2 text-[#2889CE] hover:bg-blue-50 rounded-lg">
                            FAQ
                                                ...
                                                <li onClick={() => setDropdownOpen(false)}>
                          <Link to="/events" className="block px-4 py-2 text-[#2889CE] hover:bg-blue-50 rounded-lg">
                            Events
                          </Link>
                        </li>
                      </ul>
                  ...
                  <li onClick={() => setDropdownOpen(false)}>
                    <Link to="/informasi" className="block px-4 py-2 text-[#2889CE] hover:bg-blue-50 rounded-lg transition-all">
                      Informasi
                    </Link>
                  </li>
                  <li onClick={() => setDropdownOpen(false)}>
                    <Link to="/contact" className="block px-4 py-2 text-[#2889CE] hover:bg-blue-50 rounded-lg transition-all">
                      Kontak
                    </Link>
                  </li>
<li className="mt-3">
  <div className="border border-[#2889CE] p-2 rounded-2xl text-center hover:bg-[#2889CE] transition-colors duration-200">
    <a href="http://localhost/WEBSITEHIMPUNAN/backend/login.php" className="text-[#2889CE] hover:text-white">
      Login
    </a>
  </div>
</li>
        ...
        >
          <div className="w-[200px] pl-14">
            <Link to="/">
              <img src={Logo} alt="Logo" className="h-[45px] w-auto object-contain" />
            </Link>
          </div>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 hidden pt-2 group-hover:block">
                <ul className="bg-white rounded-lg shadow-md w-48 text-sm text-left overflow-hidden">
                  <li>
                    <Link to="/visimisi" className="block px-4 py-3 text-[#2889CE] hover:bg-blue-50 transition-colors duration-200">
                      Profil Himpunan
                    </Link>
                  </li>
                  <li>
                    <Link to="/divisi" className="block px-4 py-3 text-[#2889CE] hover:bg-blue-50 transition-colors duration-200">
                      Divisi Himpunan
                    </Link>
                  </li>
                  <li>
                    <Link to="/faq" className="block px-4 py-3 text-[#2889CE] hover:bg-blue-50 transition-colors duration-200">
                      FAQ
                    </Link>
                  </li>
                                    <li>
                    <Link to="/events" className="block px-4 py-3 text-[#2889CE] hover:bg-blue-50 transition-colors duration-200">
                      Events
                    </Link>
                  </li>
                </ul>
...
<div className="flex items-center pr-6">
  <div className="bg-[#2889CE] px-6 py-2 rounded-2xl transition-colors duration-300 hover:bg-white border-2 border-[#2889CE] min-w-[100px] text-center">
    <a href="http://localhost/WEBSITEHIMPUNAN/backend/login.php" className="text-white hover:text-[#2889CE] font-medium">
      Login
    </a>
  </div>
</div>
