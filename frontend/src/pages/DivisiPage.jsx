              ...
              <div className="grid md:grid-cols-2 gap-10 items-center">
                ...
                >
                  <img
                    ...
                    className="rounded-2xl w-full h-64 object-cover shadow-lg transition-transform duration-300 group-hover:scale-105"
                  />
                  <div className="absolute inset-0 bg-black bg-opacity-30 rounded-2xl opacity-0 group-hover:opacity-100 transition duration-300 flex items-center justify-center">
                    <span className="text-white text-lg font-semibold bg-[#8E3E63] px-4 py-2 rounded-full shadow-lg">
                      Lihat Detail
                    </span>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center">
          <div className="relative bg-white rounded-2xl shadow-2xl p-6 md:p-10 max-w-3xl w-[90%] text-center">
            ...
            <p className="text-gray-700 mb-6">
              {divisiData[selectedIndex].deskripsi}
            </p>
