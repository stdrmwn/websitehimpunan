...
<div class="sidebar" id="sidebar">
    ...
    <a href="kelola_user.php" class="bg-primary"><i class="bi bi-people-fill"></i> Kelola User</a>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $row['role'] ?></td>
                        <td>
                            <button class="btn btn-warning btn-sm" onclick="fillEditModal('<?= $row['id'] ?>', '<?= htmlspecialchars($row['email']) ?>', '<?= $row['role'] ?>')">
                                <i class="bi bi-pencil-fill"></i> Edit
                            </button>
                            <a href="?hapus=<?= $row['id'] ?>" onclick="return confirm('Yakin ingin menghapus user ini?')" class="btn btn-danger btn-sm">
